...
# Função de definição dos esquemas das tabelas extraídas dos endpoints
def define_df(data, table):
    try:    
        ...
        elif(table == "sti_atendimentos_integracoes_sgt"):
            
            schema = StructType([
                StructField("idAtendimento", StringType(), nullable=True),
                StructField("dataEmissao", StringType(), nullable=True),
                StructField("dataNegociacao", StringType(), nullable=True),
                StructField("dataAceitacao", StringType(), nullable=True),
                StructField("dataExecucao", StringType(), nullable=True),
                StructField("dataRecusa", StringType(), nullable=True),
                StructField("dataConclusao", StringType(), nullable=True),
                StructField("dataCancelamento", StringType(), nullable=True)
            ])

            df_result = spark.createDataFrame(data["Atendimentos"]["Atendimento"], schema=schema)
